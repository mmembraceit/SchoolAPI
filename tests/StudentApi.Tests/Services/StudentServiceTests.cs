...
public class StudentServiceTests
{
    ...
    public StudentServiceTests()
    {
        ...
        _sut = new StudentService(_repository, _tenantContext, _publisher, _hub, _webhooks);
    }
    ...
    public async Task CreateAsync_WithValidRequest_AddsStudentAndPublishesEvent()
    {
        ...
        await _webhooks.Received(1).DispatchAsync(Arg.Any<StudentCreatedEvent>(), default);
    }
    ...
    public async Task UpdateAsync_WhenStudentExists_UpdatesAndPublishesEvent()
    {
        ...
        await _webhooks.Received(1).DispatchAsync(Arg.Any<StudentUpdatedEvent>(), default);
    }
    ...
    public async Task DeleteAsync_WhenStudentExists_DeletesAndPublishesEvent()
    {
        ...
        await _webhooks.Received(1).DispatchAsync(Arg.Any<StudentDeletedEvent>(), default);
    }
